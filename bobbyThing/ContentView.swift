...
struct ContentView: View {
    var body: some View {
        ZStack {
            ...
            EmojiView(symbol: "🥀", size: 50, x: 57,  y: -60)
            EmojiView(symbol: "😎", size: 150, x: 0,  y: -150)
            EmojiView(symbol: "👠", size: 150, x: 0,  y: 100)
            EmojiView(symbol: "👠", size: 150, x: 100,  y: 100)
            EmojiView(symbol: "👕", size: 70, x: 0,  y: -50)
            EmojiView(symbol: "🎀", size: 50, x: 0,  y: -60)
            EmojiView(symbol: "🤘", size: 50, x: -50,  y: -60)
            EmojiView(symbol: "🩳", size: 70, x: 0,  y: 10)
            EmojiView(symbol: "🎩", size: 120, x: 0,  y: -240)
        }
